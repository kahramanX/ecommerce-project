          ...
          >
            <Tab>
              <Text
                ...
                extraClass={`cursor-pointer layered-box-shadow lg:mb-4 p-2   ${
                  selectedTabIndex == 0 && "bg-grey6 text-grey1"
                }`}
                textContent="PROFILE"
              />
            </Tab>
            <Tab className="cursor-pointer">
              <Text
                ...
                fontWeight="font-bold"
                extraClass={`cursor-pointer layered-box-shadow lg:mb-4 p-2  ${
                  selectedTabIndex == 1 && "bg-grey6 text-grey1"
                }`}
                textContent="ADDRESS"
              />
            </Tab>
            <Tab className="cursor-pointer">
              <Text
                ...
                fontWeight="font-bold"
                extraClass={`cursor-pointer layered-box-shadow lg:mb-4 p-2  ${
                  selectedTabIndex == 2 && "bg-grey6 text-grey1"
                }`}
                textContent="ORDERS"
              />
            </Tab>
            <Tab className="cursor-pointer">
              <Text
                ...
                fontWeight="font-bold"
                extraClass={`cursor-pointer layered-box-shadow lg:mb-4 p-2  ${
                  selectedTabIndex == 3 && "bg-grey6 text-grey1"
                }`}
                textContent="REFUNDS"
              />
            </Tab>
            <Tab className="cursor-pointer">
              <Text
                ...
                fontWeight="font-bold"
                extraClass={`cursor-pointer layered-box-shadow lg:mb-4 p-2  ${
                  selectedTabIndex == 4 && "bg-grey6 text-grey1"
                }`}
            ...
            <Tab className="cursor-pointer">
              <Text
                ...
                fontWeight="font-bold"
                extraClass={`cursor-pointer layered-box-shadow lg:mb-4 p-2  ${
                  selectedTabIndex == 5 && "bg-grey6 text-grey1"
                }`}
                textContent="FOLLOWS"
              />
            </Tab>
            <Tab className="cursor-pointer">
              <Text
                ...
                fontWeight="font-bold"
                extraClass={`cursor-pointer layered-box-shadow lg:mb-4 p-2  ${
                  selectedTabIndex == 6 && "bg-grey6 text-grey1"
                }`}
            ...
            <Tab className="cursor-pointer">
              <Text
                ...
                fontWeight="font-bold"
                extraClass={`cursor-pointer layered-box-shadow lg:mb-4 p-2  ${
                  selectedTabIndex == 7 && "bg-grey6 text-grey1"
                }`}
